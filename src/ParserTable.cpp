...
void ParserTable::initTable()
{
    ...
    { ParserTableKey(e3.tblIndex(), "TIPO"), r3},
    { ParserTableKey(e3.tblIndex(), "main"), r3},
    { ParserTableKey(e3.tblIndex(), "if"), r3},
    { ParserTableKey(e3.tblIndex(), "while"), r3},
    { ParserTableKey(e3.tblIndex(), "for"), r3},
    { ParserTableKey(e3.tblIndex(), "id"), e6},
    { ParserTableKey(e3.tblIndex(), "const"), r3},
    ...
    { ParserTableKey(e6.tblIndex(), "("), e19},
